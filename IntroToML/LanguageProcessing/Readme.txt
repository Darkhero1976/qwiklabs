...
Introductory 5 Steps 4 hours 13 Credits

It’s no secret that machine learning is one of the fastest growing fields in tech, 
and the Google Cloud Platform has been instrumental in furthering its development. 
With a host of APIs, GCP has a tool for just about any machine learning job. 
In this introductory quest, you will get hands-on practice with machine learning 
as it applies to language processing by taking labs that will enable you 
...
2. Google Cloud Speech API: Qwik Start
   ...
   Watch these short videos Powerful Speech Recognition Using Google Machine Learning and Google Cloud Speech: 
   Qwik Start - Qwiklabs Preview
...
4. Entity and Sentiment Analysis with the Natural Language API
   ...
   In this hands-on lab you’ll learn how to extract entities and sentiment 
...
5. Speech to Text Transcription with the Cloud Speech API
   ...
   [30 minutes  Fundamental  5 Credits]
